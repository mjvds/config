...
do
  ...
  local function is_between(row, col, diag)
    ...
    -- if diag.col == diag.end_col then
    --   return ((row <= diag.col) and (row >= diag.end_col)) and
    --          ((col >= diag.lnum) and (col < diag.end_lnum))
    -- end
    -- if diag.end_col == row and col <= diag.end_lnum then
    --   return true
    -- end
    -- if diag.col == row and col >= diag.lnum then
    --   return true
    -- end
    -- return row > diag.col and row < diag.end_col
